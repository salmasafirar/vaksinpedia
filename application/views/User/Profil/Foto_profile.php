            ...
            <div class="col-sm-7">
                <div class="card">
                    <div class="card-block">
                        <form action="<?php base_url() ?>foto_user/edit" method="post" enctype="multipart/form-data">
                            ...
                            <center class="m-t-30"> <img src="<?= base_url('assets/gambar/') . $user['foto_profil'] ?>" class="img-circle" width="170" />
                                ...
                                <div class="form-group">
                                    <div class="col-sm-12">
                                        <a href="<?php echo base_url(); ?>foto_user/hapus" onclick="return confirm('Yakin ingin menghapus foto profil?')" class="btn btn-danger">Hapus Foto</a>
                ...
                <center>
                    <div class="form-group">
                        <div class="col-sm-12">
                            <a href="<?php echo base_url(); ?>setting_user" class="btn btn-success">Kembali</a>
                        </div>
                    </div>
                </center>
            </div>
