    ...
    <div class="container-fluid">
        ...
        <div class="row">
                ...
                <div class="card">
                    <div class="card-block">
                        <center class="m-t-30"> <img src="<?= base_url('assets/gambar/') . $user['foto_profil'] ?>" class="img-circle" width="140" />
                            ...
                            <div class="form-group">
                                <div class="col-sm-12">
                                    <a href="<?php echo base_url(); ?>Foto_User" class="btn btn-primary">Ubah Foto</a>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-sm-12">
                                    <a href="<?php echo base_url(); ?>Password_User" class="btn btn-secondary">Ubah Password</a>
                                </div>
                            </div>
            ...
            <div class="col-lg-8 col-xlg-9 col-md-7">
                <div class="card">
                    <div class="card-block">
                        <form action="<?php base_url() ?>Setting_User" method="POST" enctype="multipart/form-data" class="form-horizontal form-material">
