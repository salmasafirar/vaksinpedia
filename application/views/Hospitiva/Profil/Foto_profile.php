    ...
    <div class="container-fluid">
        ...
        <div class="row page-titles">
            <div class="col-md-6 col-8 align-self-center">
                ...
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="<?php base_url() ?>dashboard_hospitiva">Dashboard</a></li>
                    <li class="breadcrumb-item"><a href="<?php base_url() ?>settings_hospitiva">Account Settings</a></li>
            ...
            <div class="col-sm-7">
                <div class="card">
                    <div class="card-block">
                        <form action="<?php base_url() ?>foto_hospitiva/edit" method="post" enctype="multipart/form-data">
                            ...
                            <center class="m-t-30"> <img src="<?= base_url('assets/gambar/') . $user['foto_profil'] ?>" class="img-circle" width="170" />
                                    ...
                                    <!-- <div class="col-sm-7">
                                        <div class="input-group">
                                            ...
                                            <div class="input-group-append">
                                                <button class="btn btn-outline-primary" type="submit">Ubah Foto</button>
                                            </div>
                                        </div>
                                    </div> -->
                                    <div class="col-sm-5">
                                ...
                                <div class="form-group">
                                    <div class="col-sm-12">
                                        <a href="<?php echo base_url(); ?>foto_hospitiva/hapus" onclick="return confirm('Yakin ingin menghapus foto profil?')" class="btn btn-danger">Hapus Foto</a>
                ...
                <center>
                    <div class="form-group">
                        <div class="col-sm-12">
                            <a href="<?php echo base_url(); ?>setting_hospitiva" class="btn btn-success">Kembali</a>
                        </div>
                    </div>
                </center>
            </div>
