            ...
            <div class="col-sm-7">
                <div class="card">
                    <div class="card-block">
                        <form action="<?php base_url() ?>password_hospitiva" method="POST" enctype="multipart/form-data" class="form-horizontal form-material">
                            ...
                            <div class="form-group">
                                <div class="col-sm-12">
                                    <a href="<?php echo base_url(); ?>setting_hospitiva" class="btn btn-danger">Batal</a>
