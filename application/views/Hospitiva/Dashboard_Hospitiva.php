<title>Dashboard Hospitiva</title>
<!-- ============================================================== -->
<!-- Page wrapper  -->
<!-- ============================================================== -->
                                ...
                                <tbody>
                                    ...
                                    foreach ($dataSchedule2->result() as $row) { ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a id="set_dtl" class="btn btn-primary btn-xs" data-toggle="modal" data-target="#modal_detail" data-lokasi="<?= $row->lokasi; ?>" data-tanggal_vaksin="<?= $row->tanggal_vaksin; ?>" data-nama_vaksin="<?= $row->nama_vaksin; ?>" data-jumlah_vaccinery="<?= $row->jumlah_vaccinery; ?>" data-alamat="<?= $row->alamat ?>" data-nomor_telepon="<?= $row->nomor_telepon ?>" style="color: white;">
                                                Detail</a>
                                            </td>
                                        </tr>
                                    <?php }
